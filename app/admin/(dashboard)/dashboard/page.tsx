...
export default async function AdminDashboardPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-bold text-neutral-900 dark:text-neutral-100">แดชบอร์ด</h1>
      <p className="mt-1 text-neutral-500">ภาพรวมของเว็บไซต์ Deals Thai</p>
      ...
      <div className="mt-8 card-surface p-6">
        <h2 className="mb-2 font-semibold">เริ่มต้นใช้งาน</h2>
